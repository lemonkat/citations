...
definitions = {
    ...
    'create_biblio_MLA_helper':[
        ...
        [
            'append', 
            ['print', '''Possible source types: online_article, whole_website, book, image, and manual. 
        ...
        for subExp in expression:
            if subExp in accessList:
                try:
                    ...
                    raise Exception('Missing inputs! exp: ' + str(expression) + ' inputs: ' + str(inputs))
            else:
